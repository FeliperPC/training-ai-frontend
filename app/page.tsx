  ...
  return (
    <div className="flex min-h-dvh flex-col bg-background pb-24 md:pb-32">
      <div className="mx-auto flex w-full max-w-3xl flex-col lg:max-w-5xl">
        <div className="relative flex h-[296px] shrink-0 flex-col items-start justify-between overflow-hidden rounded-b-[20px] px-5 pb-10 pt-5 md:h-[340px] md:rounded-[20px] md:mt-5 md:px-8 lg:h-[380px]">
          ...
          <div className="relative flex w-full items-end justify-between">
            <div className="flex flex-col gap-1.5">
              ...
              <p className="font-inter-tight text-sm leading-[1.15] text-background/70 md:text-base">
                Bora treinar hoje?
              </p>
            </div>
        ...
        <div className="grid gap-0 lg:grid-cols-[1fr_1.4fr] lg:gap-6 lg:px-3 lg:pt-2">
          <div className="flex flex-col gap-3 px-5 pt-5 md:px-8 lg:px-0 lg:pt-3">
          ...
          <div className="flex flex-col gap-3 p-5 md:px-8 md:pt-5 lg:p-0 lg:pt-3">
            <div className="flex items-center justify-between">
              <h2 className="font-inter-tight text-lg font-semibold leading-[1.4] text-foreground">
                Treino de Hoje
              </h2>
